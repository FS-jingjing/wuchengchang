...
-->
  ...
  <table width="912" height="693" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
    ...
    <tr>
      <td colspan="2" align="center"><img src="image/lvseHuaHui.jpg" width="908" height="152"></td>
    </tr>
    <tr>
      <td height="31" colspan="2"><table width="912" height="31" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="721" background="image/banner_bg1.gif"><strong><font color="#FF9900">&gt;&gt;</font></strong><span class="font">绿植花卉</span></td>
          </tr>
      </table></td>
    </tr>
    <tr>
      <td height="240" colspan="2" ><table  height="82" border="0" cellpadding="0" cellspacing="0" style="margin:5px 5px 5px 5px">
          <c:forEach items="${flowerList}" var="lv" varStatus="count">
            <c:if test="${count.index%5==0}">
              <tr>            </c:if>
            <td width="180" align="center"><table width="180" height="207" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="180" height="141" align="center"><a href="FlowerDetailsServlet?flowerId=${lv.flowerId}"><img src="image/${lv.flowerImage}" width="117" height="130" border="0"></a></td>
              </tr>
              <tr>
                <td align="center" class="font"><a href="">${lv.flowerName}</a></td>
              </tr>
              <tr>
                <td align="center" class="font">市场价：￥${lv.price}</td>
              </tr>
              <tr>
                <td align="center" class="font">现价：<font color="red">￥${lv.currentPrice}</font></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="center"><a href="ShopCartServlet?flowerId=${lv.flowerId}"><img src="image/shop.gif" width="40" height="17" border="0"></a>&nbsp; <a href="FlowerDetailsServlet?flowerId=${lv.flowerId}"><img src="image/details.gif" width="40" height="17" border="0"></a></td>
              </tr>
            </table></td>
    ...
    <tr>
      <td colspan="3" align="right" class="font"><c:if test="${page==1}"> 上一页 </c:if>
          <c:if test="${page>1}"> <a href="FlowerListServlet?types=shang&type=3">上一页</a> </c:if>
        |
        <c:if test="${page==pageSum}"> 下一页 </c:if>
        <c:if test="${page<pageSum}"> <a href="FlowerListServlet?types=xia&type=3">下一页 </a> </c:if>
